...
_RECOGNITIONCONFIG_ENCODING = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ALAW8000', index=6, number=6,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OPUS', index=7, number=7,
      serialized_options=None,
      type=None),
  ],
...
_CUBIC = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\030\"\023/api/compilecontext:\001*',
  ),
])
