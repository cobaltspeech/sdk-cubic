...
public final class CubicGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cobaltspeech.cubic.CubicOuterClass.CompileContextRequest,
      cobaltspeech.cubic.CubicOuterClass.CompileContextResponse> getCompileContextMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CompileContext",
      requestType = cobaltspeech.cubic.CubicOuterClass.CompileContextRequest.class,
      responseType = cobaltspeech.cubic.CubicOuterClass.CompileContextResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cobaltspeech.cubic.CubicOuterClass.CompileContextRequest,
      cobaltspeech.cubic.CubicOuterClass.CompileContextResponse> getCompileContextMethod() {
    io.grpc.MethodDescriptor<cobaltspeech.cubic.CubicOuterClass.CompileContextRequest, cobaltspeech.cubic.CubicOuterClass.CompileContextResponse> getCompileContextMethod;
      ...
      synchronized (CubicGrpc.class) {
        if ((getCompileContextMethod = CubicGrpc.getCompileContextMethod) == null) {
          CubicGrpc.getCompileContextMethod = getCompileContextMethod = 
              io.grpc.MethodDescriptor.<cobaltspeech.cubic.CubicOuterClass.CompileContextRequest, cobaltspeech.cubic.CubicOuterClass.CompileContextResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "cobaltspeech.cubic.Cubic", "CompileContext"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cobaltspeech.cubic.CubicOuterClass.CompileContextRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cobaltspeech.cubic.CubicOuterClass.CompileContextResponse.getDefaultInstance()))
  ...
  public static abstract class CubicImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void compileContext(cobaltspeech.cubic.CubicOuterClass.CompileContextRequest request,
        io.grpc.stub.StreamObserver<cobaltspeech.cubic.CubicOuterClass.CompileContextResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                cobaltspeech.cubic.CubicOuterClass.CompileContextRequest,
                cobaltspeech.cubic.CubicOuterClass.CompileContextResponse>(
  ...
  public static final class CubicBlockingStub extends io.grpc.stub.AbstractStub<CubicBlockingStub> {
     ...
     * </pre>
     */
    public cobaltspeech.cubic.CubicOuterClass.CompileContextResponse compileContext(cobaltspeech.cubic.CubicOuterClass.CompileContextRequest request) {
      return blockingUnaryCall(
  ...
  public static final class CubicFutureStub extends io.grpc.stub.AbstractStub<CubicFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<cobaltspeech.cubic.CubicOuterClass.CompileContextResponse> compileContext(
        cobaltspeech.cubic.CubicOuterClass.CompileContextRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_COMPILE_CONTEXT:
          serviceImpl.compileContext((cobaltspeech.cubic.CubicOuterClass.CompileContextRequest) request,
              (io.grpc.stub.StreamObserver<cobaltspeech.cubic.CubicOuterClass.CompileContextResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CubicBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cobaltspeech.cubic.CubicOuterClass.getDescriptor();
    }
