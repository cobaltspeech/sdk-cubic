...
extension Cobaltspeech_Cubic_RecognitionConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.modelID)
      case 2: try decoder.decodeSingularEnumField(value: &self.audioEncoding)
      case 3: try decoder.decodeSingularMessageField(value: &self._idleTimeout)
      case 4: try decoder.decodeSingularBoolField(value: &self.enableWordTimeOffsets)
      case 5: try decoder.decodeSingularBoolField(value: &self.enableWordConfidence)
      case 6: try decoder.decodeSingularBoolField(value: &self.enableRawTranscript)
...
extension Cobaltspeech_Cubic_RecognitionMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.customMetadata)
      default: break
      }
    }
  }
...
extension Cobaltspeech_Cubic_Model: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularMessageField(value: &self._attributes)
      default: break
      }
    }
  }
...
extension Cobaltspeech_Cubic_ModelAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularMessageField(value: &self._contextInfo)
      default: break
      }
    }
  }
...
extension Cobaltspeech_Cubic_ContextInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularBoolField(value: &self.supportsContext)
      case 2: try decoder.decodeRepeatedStringField(value: &self.allowedContextTokens)
      default: break
      }
    }
  }
...
extension Cobaltspeech_Cubic_RecognitionResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularBoolField(value: &self.isPartial)
      case 3: try decoder.decodeSingularMessageField(value: &self._cnet)
      case 4: try decoder.decodeSingularUInt32Field(value: &self.audioChannel)
      default: break
      }
    }
  }
...
extension Cobaltspeech_Cubic_WordInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try decoder.decodeSingularMessageField(value: &self._duration)
      default: break
      }
    }
  }
...
extension Cobaltspeech_Cubic_ConfusionNetworkLink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeRepeatedMessageField(value: &self.arcs)
      default: break
      }
    }
  }
