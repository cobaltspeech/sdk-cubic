...
struct Cobaltspeech_Cubic_ListModelsRequest {
...
struct Cobaltspeech_Cubic_RecognizeRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cobaltspeech_Cubic_StreamingRecognizeRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    static func ==(lhs: Cobaltspeech_Cubic_StreamingRecognizeRequest.OneOf_Request, rhs: Cobaltspeech_Cubic_StreamingRecognizeRequest.OneOf_Request) -> Bool {
      switch (lhs, rhs) {
...
struct Cobaltspeech_Cubic_VersionResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// version of the cubic library handling the recognition
  var cubic: String = String()
...
struct Cobaltspeech_Cubic_ListModelsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cobaltspeech_Cubic_RecognitionConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var audioEncoding: Cobaltspeech_Cubic_RecognitionConfig.Encoding {
  ...
  var idleTimeout: SwiftProtobuf.Google_Protobuf_Duration {
  ...
  var hasIdleTimeout: Bool {return _storage._idleTimeout != nil}
  /// Clears the value of `idleTimeout`. Subsequent reads from it will return its default value.
  mutating func clearIdleTimeout() {_uniqueStorage()._idleTimeout = nil}
  ...
  var enableConfusionNetwork: Bool {
  ...
  enum Encoding: SwiftProtobuf.Enum {
...
extension Cobaltspeech_Cubic_RecognitionConfig.Encoding: CaseIterable {
  ...
  static var allCases: [Cobaltspeech_Cubic_RecognitionConfig.Encoding] = [
    .rawLinear16,
    .wav,
    .mp3,
    .flac,
...
struct Cobaltspeech_Cubic_RecognitionAudio {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cobaltspeech_Cubic_Model {
  ...
  /// Model attributes
  var attributes: Cobaltspeech_Cubic_ModelAttributes {
...
struct Cobaltspeech_Cubic_ModelAttributes {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cobaltspeech_Cubic_RecognitionResult {
  ...
  /// results.
  var cnet: Cobaltspeech_Cubic_RecognitionConfusionNetwork {
  ...
  var hasCnet: Bool {return _storage._cnet != nil}
  /// Clears the value of `cnet`. Subsequent reads from it will return its default value.
  mutating func clearCnet() {_uniqueStorage()._cnet = nil}
...
struct Cobaltspeech_Cubic_RecognitionAlternative {
  ...
  var words: [Cobaltspeech_Cubic_WordInfo] {
...
struct Cobaltspeech_Cubic_WordInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cobaltspeech_Cubic_RecognitionConfusionNetwork {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var links: [Cobaltspeech_Cubic_ConfusionNetworkLink] = []
...
struct Cobaltspeech_Cubic_ConfusionNetworkLink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var arcs: [Cobaltspeech_Cubic_ConfusionNetworkArc] {
...
struct Cobaltspeech_Cubic_ConfusionNetworkArc {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cobaltspeech_Cubic_ListModelsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cobaltspeech_Cubic_ListModelsRequest, rhs: Cobaltspeech_Cubic_ListModelsRequest) -> Bool {
...
extension Cobaltspeech_Cubic_RecognizeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cobaltspeech_Cubic_RecognizeRequest, rhs: Cobaltspeech_Cubic_RecognizeRequest) -> Bool {
...
extension Cobaltspeech_Cubic_StreamingRecognizeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cobaltspeech_Cubic_StreamingRecognizeRequest, rhs: Cobaltspeech_Cubic_StreamingRecognizeRequest) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Cobaltspeech_Cubic_VersionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cobaltspeech_Cubic_VersionResponse, rhs: Cobaltspeech_Cubic_VersionResponse) -> Bool {
...
extension Cobaltspeech_Cubic_ListModelsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cobaltspeech_Cubic_ListModelsResponse, rhs: Cobaltspeech_Cubic_ListModelsResponse) -> Bool {
...
extension Cobaltspeech_Cubic_RecognitionConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cobaltspeech_Cubic_RecognitionConfig, rhs: Cobaltspeech_Cubic_RecognitionConfig) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Cobaltspeech_Cubic_RecognitionAudio: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cobaltspeech_Cubic_RecognitionAudio, rhs: Cobaltspeech_Cubic_RecognitionAudio) -> Bool {
...
extension Cobaltspeech_Cubic_ModelAttributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ModelAttributes"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Cobaltspeech_Cubic_ModelAttributes, rhs: Cobaltspeech_Cubic_ModelAttributes) -> Bool {
...
extension Cobaltspeech_Cubic_WordInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cobaltspeech_Cubic_WordInfo, rhs: Cobaltspeech_Cubic_WordInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Cobaltspeech_Cubic_RecognitionConfusionNetwork: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".RecognitionConfusionNetwork"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "links"),
  ]
  ...
  static func ==(lhs: Cobaltspeech_Cubic_RecognitionConfusionNetwork, rhs: Cobaltspeech_Cubic_RecognitionConfusionNetwork) -> Bool {
...
extension Cobaltspeech_Cubic_ConfusionNetworkLink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ConfusionNetworkLink"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Cobaltspeech_Cubic_ConfusionNetworkLink, rhs: Cobaltspeech_Cubic_ConfusionNetworkLink) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Cobaltspeech_Cubic_ConfusionNetworkArc: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ConfusionNetworkArc"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "word"),
    2: .same(proto: "confidence"),
  ]
  ...
  static func ==(lhs: Cobaltspeech_Cubic_ConfusionNetworkArc, rhs: Cobaltspeech_Cubic_ConfusionNetworkArc) -> Bool {
