...
public class CubicClient: Cobaltspeech_Cubic_CubicServiceClient{}

public class CubicManager: NSObject, AVAudioRecorderDelegate {
    
    private let client: CubicClient
    ...
    public required init(client: CubicClient) {
        self.client = client
    }
    
    public init(url: String) {
        self.client = CubicClient(channel: Channel(address: url))
    }
